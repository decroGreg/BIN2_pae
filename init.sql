...
INSERT INTO init.utilisateurs VALUES(DEFAULT, 'chri', 'Damas', 'Christophe', 'Bruxelles', 'christophe.damas@vinci.be', '2020-04-01', '$2a$10$XnE81FS9i3aEPs6DXQVw3OZzf3Cw04sDhg4dfXqx45w/T4P6AhdUy', 'O');
...
INSERT INTO init.utilisateurs VALUES(DEFAULT, 'bazz', 'Ile', 'Basile', 'Liège', 'bas.ile@gmail.be', '2020-04-01', '$2a$10$qx2s5Vy1f00ePAsCHNzWGuROzKWzP3YcxWfKvhYveLDkoMAq3lrDy', 'C');
...
INSERT INTO init.types_amenagement VALUES(DEFAULT, 'Aménagement de jardin de ville');
INSERT INTO init.types_amenagement VALUES(DEFAULT, 'Aménagement de jardin');
INSERT INTO init.types_amenagement VALUES(DEFAULT, 'Aménagement de parc paysagiste');
INSERT INTO init.types_amenagement VALUES(DEFAULT, 'Création de potagers');
...
INSERT INTO init.types_amenagement VALUES(DEFAULT, 'Aménagement d''étang');
INSERT INTO init.types_amenagement VALUES(DEFAULT, 'Installation de système d''arrosage automatique');
...
INSERT INTO init.clients VALUES(DEFAULT, 'Ile', 'Théophile', 'Rue de Renkin', 7, NULL, 4800, 'Verviers', 'theo.phile@proximus.be', '082.25.69.74', NULL);
